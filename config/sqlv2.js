module.exports = {
    ...
    holdings: {
        getAll              : `SELECT "HOLDINGS_ID", "BROKER_ID",TO_TIMESTAMP("DATE")::date AS "DATE", "SYMBOL", "QUANTITY", "PRICE", "INDUSTRY", "INDEX", TO_TIMESTAMP("UPDATED_DATE")::date AS "UPDATED_DATE" FROM holdings WHERE "USER_ID" = $1 AND "WORKSPACE_ID" = $2`,
        getByBroker         : `SELECT "HOLDINGS_ID", "BROKER_ID", TO_TIMESTAMP("DATE")::date AS "DATE", "SYMBOL", "QUANTITY", "PRICE", "INDUSTRY", "INDEX", TO_TIMESTAMP("UPDATED_DATE")::date AS "UPDATED_DATE" FROM holdings WHERE "USER_ID" = $1 AND "WORKSPACE_ID" = $2 AND "BROKER_ID" = $3`,
