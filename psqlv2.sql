...
CREATE TABLE broker
(
    "BROKER_ID"     BIGSERIAL NOT NULL,
    "USER_ID"       BIGINT NOT NULL,
    "NAME"          VARCHAR(100) NOT NULL,
    "URL"           VARCHAR(100),
    CONSTRAINT "Broker_PK" PRIMARY KEY ( "BROKER_ID" ),
    CONSTRAINT "Broker_FK" FOREIGN KEY ( "USER_ID" ) REFERENCES "userinfo" ( "USER_ID" ) ON DELETE CASCADE
...
(
    ...
    CONSTRAINT "Holdings_FK1" FOREIGN KEY ( "BROKER_ID" ) REFERENCES "broker" ( "BROKER_ID" ),
    CONSTRAINT "Holdings_FK2" FOREIGN KEY ( "WORKSPACE_ID" ) REFERENCES "workspace" ( "WORKSPACE_ID" )
);
...
(
    ...
    CONSTRAINT "Solds_FK" FOREIGN KEY ( "BROKER_ID" ) REFERENCES "broker" ( "BROKER_ID" ),
    CONSTRAINT "Solds_FK1" FOREIGN KEY ( "USER_ID" ) REFERENCES "userinfo" ( "USER_ID" ) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT "Transactions_FK" FOREIGN KEY ( "BROKER_ID" ) REFERENCES "broker" ( "BROKER_ID" ),
    CONSTRAINT "Transactions_FK1" FOREIGN KEY ( "USER_ID" ) REFERENCES "userinfo" ( "USER_ID" ) ON DELETE CASCADE
)
